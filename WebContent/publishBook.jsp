			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="file" class="form-control" id="content" name="content"
						placeholder="Content" required="required" value="${param.content}" />
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="tags" name="tags"
						placeholder="Tags" value="${parma.tags}" />
					<div class="addTagsHint text-left">
						Put a comma between each one. Example: <strong>fantasy,
							sci-fi, romance</strong>
					</div>
				</div>
			</div>
			<div class="form-group">
